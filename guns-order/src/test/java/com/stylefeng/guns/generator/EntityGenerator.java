...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("D:\\code\\iworkspace\\imooc\\guns\\guns-order\\src\\main\\java");//这里写你自己的java目录
        ...
        dsc.setUrl("jdbc:mysql://192.168.185.129:3306/guns_rest?autoReconnect=true&useUnicode=true&characterEncoding=utf8&serverTimezone=GMT%2B8");
        ...
        strategy.setInclude(new String[]{"meeting_order_t"});
